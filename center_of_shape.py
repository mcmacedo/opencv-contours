...
def get_processed_image(image_path):
    """
    Altera a imagem para escala de cor de cinza, aplique um pouco de blur e remova os ruídos.
...
if __name__ == '__main__':
    ...
    for contour in contours:
        ...
        # Desenha o contour no centro da forma na imagem original
        cv2.drawContours(image, [contour], -1, (0, 255, 0), 2)
        cv2.circle(image, (contour_x, contour_y), 7, (255, 255, 255), -1)
        cv2.putText(image, "center", (contour_x - 20, contour_y - 20),
